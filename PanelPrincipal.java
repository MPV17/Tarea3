...
public class PanelPrincipal extends JPanel implements MouseListener{
    ...
    private int ManoCoc = 0;
    private int ManoSpr = 0;
    private int ManoFan = 0;
    ...
    public void mousePressed(MouseEvent me){
        ...
        if (me.getX()>= 100 && me.getX() <= 500 && me.getY() >= 525 && me.getY()<= 650){
            ...
            b = false;
            c = false;
            ManoCoc = ManoCoc + NumCoc;
            ManoSpr = ManoSpr + NumSpr;
            ManoFan = ManoFan + NumFan;
            NumCoc = 0;
            NumSpr = 0;
            NumFan = 0;
        }
    ...
    public void paint (Graphics g) { //todo se dibuja a partir de este método
        ...
        g.setColor(black);
        g.drawString("Tienes " + ManoCoc + " CocaCola(s).", 1000, 30);
        g.drawString("Tienes " + ManoSpr + " Sprite(s).", 1000, 60);
        g.drawString("Tienes " + ManoFan + " Fanta(s).", 1000, 90);
    ...
    public void actionPerformed(MouseEvent a) {
        ManoCoc = ManoCoc - 1;
        if (NumCoc < 0) NumCoc = 0;
    }
}
